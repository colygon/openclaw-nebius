...
Always use the `nebius/` prefix for model names (e.g., `nebius/zai-org/GLM-5`). See the [tokenfactory-plugin](https://github.com/colygon/openclaw-nebius/tree/main/tokenfactory-plugin) for the full model catalog and pricing.
